            ...
            <center>
                ...
                <div class="prev-update"><h1 id="add-h1">Add a new Assignment</h1>
                    ...
                    <div class="add-new-update">
                        ...
                        <input type="text" placeholder="Title of Assignment"><br>
                        Posting Date: <?php echo $currentDate; ?>
                            
                            <br>
                            <textarea id="assn-desc" name="text" id="textarea" placeholder="Description and Instructions for assignment"></textarea>
                            <br>
                            ...
                            <div class="dload">
                                ...
                                <img src="../img/dload.png"><a href="">this.doc</a><br></div>
